        ...
        <Card className="shadow-premium border-gray-100">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <NavLink to={ROUTES.FORGOT_PASSWORD} className="text-sm text-brand-600 hover:text-brand-700 font-medium">
                    Forgot password?
                  </NavLink>
                </div>
          ...
          <CardFooter className="flex justify-center border-t border-gray-50 pt-6">
            <p className="text-sm text-gray-600">
              ...
              <NavLink to={ROUTES.REGISTER} className="font-semibold text-brand-600 hover:text-brand-700">
                Sign up
              </NavLink>
            </p>
          </CardFooter>
