    ...
    <div className="flex flex-col min-h-screen bg-gray-50/30">
      <section className="pt-24 pb-16 bg-white border-b border-gray-100">
        <Container className="max-w-3xl">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-tight">Company Preparation</h1>
          <p className="text-xl text-gray-600 leading-relaxed">
            Practice the specific patterns and question formats tested by top technology companies. Don't guess what they'll ask—be prepared.
          </p>
        </Container>
      </section>
